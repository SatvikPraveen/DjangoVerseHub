...
class SearchAPITests(APITestCase):
    ...
    def setUpTestData(cls):
        ...
        cls.private = User.objects.create_user(
            email="p@example.com", username="private", password="x", first_name="Wrenna"
        )
        ...
        article = Article.objects.create(
            title="Async Django", content="...", author=cls.author, category=cls.category, status="published"
        )
...
class StatsAndTrendingTests(APITestCase):
    ...
    def setUpTestData(cls):
        ...
        cls.hot = Article.objects.create(
            title="Hot", content="...", author=cls.author, status="published", views_count=50
        )
        cls.cold = Article.objects.create(
            title="Cold", content="...", author=cls.author, status="published", views_count=1
        )
