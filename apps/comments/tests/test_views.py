...
class CommentViewTest(TestCase):
    ...
    def test_comment_create_view_authenticated(self):
        ...
        url = reverse("comments:create")
        response = self.client.get(url, {"content_type": content_type.id, "object_id": self.article.id})
    ...
    def test_comment_unlike_ajax(self):
        ...
        self.assertFalse(CommentLike.objects.filter(comment=self.comment, user=self.other_user).exists())
