...
from .models import (
    MAX_THREAD_DEPTH, REMOVED_PLACEHOLDER, Comment, CommentLike, target_accepts_comments,
)
...
class CommentSerializer(_ViewerFieldsMixin, serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'thread_depth', 'can_edit', 'can_delete', 'liked',
...
class CommentTreeSerializer(_ViewerFieldsMixin, serializers.ModelSerializer):
    ...
    class Meta:
        model = Comment
        fields = [
            'id', 'author', 'content', 'depth', 'is_active', 'is_placeholder',
            'is_edited', 'likes_count', 'can_edit', 'can_delete', 'liked',
