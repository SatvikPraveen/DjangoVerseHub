...
class CommentListView(ListView):
    ...
    def get_queryset(self):
        ...
        return queryset.annotate(active_reply_count=Count("replies", filter=Q(replies__is_active=True))).order_by(
            "-created_at"
        )
...
class CommentViewSet(viewsets.ModelViewSet):
    ...
    def tree(self, request):
        ...
        comments = list(Comment.objects.filter(content_type=ct, object_id=str(object_id)).with_author())
