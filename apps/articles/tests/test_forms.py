...
class ArticleFormTest(TestCase):
    ...
    def test_article_form_featured_image_validation(self):
        ...
        with tempfile.NamedTemporaryFile(suffix=".jpg", delete=False) as tmp_file:
            ...
            form = ArticleForm(data=form_data, files={"featured_image": large_file}, user=self.user)
            self.assertFalse(form.is_valid())
...
class CategoryFormTest(TestCase):
    def test_category_form_valid_data(self):
        form_data = {"name": "Technology", "description": "Articles about technology", "is_active": True}
    ...
    def test_category_form_name_validation(self):
        ...
        form_data = {"name": "Existing Category", "description": "Test description"}
        form = CategoryForm(data=form_data)
        self.assertFalse(form.is_valid())
    ...
    def test_category_form_image_validation(self):
        ...
        form_data = {"name": "Test Category", "description": "Test description"}
        form = CategoryForm(
            data=form_data,
    ...
    def test_category_form_save(self):
        form_data = {"name": "New Category", "description": "New category description", "is_active": True}
        form = CategoryForm(data=form_data)
        self.assertTrue(form.is_valid())
