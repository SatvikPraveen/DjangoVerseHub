...
class ArticleListViewTest(TestCase):
    def setUp(self):
        ...
        self.article = Article.objects.create(
            title="Test Article", content="Test content", author=self.user, status="published"
        )
    ...
    def test_article_list_view_pagination(self):
        ...
        for i in range(15):
            Article.objects.create(
                title=f"Test Article {i}", content=f"Test content {i}", author=self.user, status="published"
            )
...
class CategoryViewTest(TestCase):
    def setUp(self):
        ...
        self.article = Article.objects.create(
            title="Tech Article", content="Tech content", author=self.user, category=self.category, status="published"
        )
...
class SearchViewTest(TestCase):
    def setUp(self):
        ...
        self.user = User.objects.create_user(email="test@example.com", first_name="Test", last_name="User")
        self.article = Article.objects.create(
            title="Django Tutorial", content="Learn Django framework", author=self.user, status="published"
        )
...
class AutocompleteViewTest(TestCase):
    def setUp(self):
        ...
        self.user = User.objects.create_user(email="test@example.com", first_name="Test", last_name="User")
        self.article = Article.objects.create(
            title="Django Tutorial", content="Learn Django", author=self.user, status="published"
        )
...
class TrendingViewTest(TestCase):
    def setUp(self):
        ...
        self.user = User.objects.create_user(email="test@example.com", first_name="Test", last_name="User")
        self.article = Article.objects.create(
            title="Trending Article", content="Trending content", author=self.user, status="published", views_count=100
        )
