...
class ArticleForm(forms.ModelForm):
    ...
    title = forms.CharField(
        max_length=200, widget=forms.TextInput(attrs={"class": "form-control", "placeholder": "Enter article title..."})
    )
    ...
    summary = forms.CharField(
        ...
        widget=forms.Textarea(
            attrs={"class": "form-control", "rows": 3, "placeholder": "Brief summary of your article..."}
        ),
    )

    content = forms.CharField(
        widget=forms.Textarea(
            attrs={"class": "form-control", "rows": 15, "placeholder": "Write your article content here..."}
        )
    )
    ...
    meta_description = forms.CharField(
        max_length=160,
        required=False,
        widget=forms.TextInput(attrs={"class": "form-control", "placeholder": "SEO meta description..."}),
    )
...
class CategoryForm(forms.ModelForm):
    ...
    name = forms.CharField(
        max_length=100, widget=forms.TextInput(attrs={"class": "form-control", "placeholder": "Category name..."})
    )
...
class TagForm(forms.ModelForm):
    ...
    name = forms.CharField(
        max_length=50, widget=forms.TextInput(attrs={"class": "form-control", "placeholder": "Tag name..."})
    )
...
class ArticleFilterForm(forms.Form):
    ...
    min_views = forms.IntegerField(
        required=False,
        min_value=0,
        widget=forms.NumberInput(attrs={"class": "form-control", "placeholder": "Minimum views..."}),
    )

    featured_only = forms.BooleanField(required=False, widget=forms.CheckboxInput(attrs={"class": "form-check-input"}))
