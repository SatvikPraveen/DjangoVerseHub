...
def cache_user_data(timeout=USER_CACHE_TIMEOUT):
    ...
    def decorator(func):
        ...
        def wrapper(*args, **kwargs):
            ...
            key_data = {"func": func.__name__, "args": str(args), "kwargs": str(sorted(kwargs.items()))}
...
class ProfileSearchCache:
    ...
    def invalidate_search_cache():
        ...
        cache.delete_many([key for key in cache._cache if key.startswith("profile_search:")])
