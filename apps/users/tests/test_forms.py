...
class CustomLoginFormTest(TestCase):
    ...
    def test_valid_login_with_email(self):
        ...
        CustomLoginForm(data=form_data)
    ...
    def test_invalid_credentials(self):
        ...
        form_data = {"username": "test@example.com", "password": "wrongpass"}
        CustomLoginForm(data=form_data)
...
class ProfileFormTest(TestCase):
    ...
    def test_invalid_website_url(self):
        ...
        form_data = {"website": "not-a-valid-url"}
        form = ProfileForm(data=form_data, instance=self.profile)
        self.assertFalse(form.is_valid())
    ...
    def test_avatar_size_validation(self):
        ...
        ProfileForm(data=form_data, files=form_files, instance=self.profile)  # type: ignore[arg-type]
...
class UserUpdateFormTest(TestCase):
    ...
    def test_valid_phone_formats(self):
        ...
        valid_phones = ["+1234567890", "(123) 456-7890", "123-456-7890", "123 456 7890"]
...
class PasswordChangeFormTest(TestCase):
    ...
    def setUp(self):
        self.user = User.objects.create_user(email="test@example.com", username="testuser", password="oldpass123")

    def test_valid_password_change(self):
        """Test valid password change"""
        form_data = {"current_password": "oldpass123", "new_password1": "newpass123", "new_password2": "newpass123"}
        form = PasswordChangeForm(self.user, data=form_data)
        self.assertTrue(form.is_valid())

    def test_incorrect_current_password(self):
        """Test with incorrect current password"""
        form_data = {"current_password": "wrongpass", "new_password1": "newpass123", "new_password2": "newpass123"}
        form = PasswordChangeForm(self.user, data=form_data)
        self.assertFalse(form.is_valid())
