...
class CustomUserModelTest(TestCase):
    ...
    def test_create_superuser(self):
        ...
        user = User.objects.create_superuser(email="admin@example.com", username="admin", password="adminpass123")
    ...
    def test_email_unique_constraint(self):
        ...
        with self.assertRaises(IntegrityError):
            User.objects.create_user(
                email=self.user_data["email"], username="different_username", password="password123"
            )
    ...
    def test_username_unique_constraint(self):
        ...
        with self.assertRaises(IntegrityError):
            User.objects.create_user(
                email="different@example.com", username=self.user_data["username"], password="password123"
            )
...
class ProfileModelTest(TestCase):
    ...
    def test_profile_url_fields(self):
        ...
        valid_urls = ["https://example.com", "http://www.example.com", "https://twitter.com/username"]
    ...
    def test_profile_managers(self):
        ...
        User.objects.create_user(email="user2@example.com", username="user2", password="pass123")
        User.objects.create_user(email="inactive@example.com", username="inactive", password="pass123", is_active=False)
        private_user = User.objects.create_user(email="private@example.com", username="private", password="pass123")
    ...
    def test_profile_search(self):
        ...
        user2 = User.objects.create_user(email="john@example.com", username="johndoe", password="pass123")
