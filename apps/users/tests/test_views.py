...
class UserViewsTest(TestCase):
    ...
    def test_profile_detail_private_profile(self):
        ...
        # Create another user
        User.objects.create_user(email="other@example.com", username="other", password="pass123")
    ...
    def test_user_list_view(self):
        ...
        User.objects.create_user(email="user3@example.com", username="user3", password="pass123")
    ...
    def test_user_list_search(self):
        ...
        User.objects.create_user(email="john@example.com", username="johndoe", password="pass123")
    ...
    def test_user_list_pagination(self):
        ...
        for i in range(25):
            User.objects.create_user(email=f"user{i}@example.com", username=f"user{i}", password="pass123")
