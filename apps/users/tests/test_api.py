...
class UserAPITest(TestCase):
    ...
    def setUp(self):
        ...
        self.user = User.objects.create_user(
            email="test@example.com", username="testuser", password="testpass123", first_name="Test", last_name="User"
        )
    ...
    def test_change_password_api(self):
        ...
        data = {"current_password": "testpass123", "new_password": "newpass123", "new_password_confirm": "newpass123"}
        response = self.client.post(url, data)
    ...
    def test_change_password_wrong_current(self):
        ...
        self.client.credentials(HTTP_AUTHORIZATION="Token " + self.token.key)
        url = reverse("users:user-change-password")
        data = {"current_password": "wrongpass", "new_password": "newpass123", "new_password_confirm": "newpass123"}
        response = self.client.post(url, data)
...
class ProfileAPITest(TestCase):
    ...
    def test_update_own_profile(self):
        ...
        data = {"full_name": "Updated Name", "bio": "Updated bio", "location": "New Location", "theme": "dark"}
