...
class ImmediateEmailTaskTest(TestCase):
    def setUp(self):
        ...
        self.notification = Notification.objects.create(recipient=self.user, notification_type='follow', message='X started following you.')
        mail.outbox.clear()
...
class CleanupTaskTest(TestCase):
    ...
    def make(self, days_old, is_read, read_at_set=True):
        ...
        Notification.objects.filter(pk=n.pk).update(
            created_at=stamp, is_read=is_read,
