...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument(
            "--notifications", type=int, default=200, help="Number of notifications to create (default: 200)"
        )
        parser.add_argument("--admin", action="store_true", help="Create admin users")
        parser.add_argument("--clear", action="store_true", help="Clear existing demo data before creating new")
    ...
    def clear_demo_data(self):
        ...
        demo_users = User.objects.filter(is_superuser=False, email__contains="example.com")

        notifications_count = Notification.objects.filter(recipient__in=demo_users).count()
        ...
        self.stdout.write(self.style.SUCCESS(f"Cleared {users_count} users and {notifications_count} notifications"))
    ...
    def create_user_groups(self):
        ...
        groups = []
        for name, _description in groups_data:
    ...
    def create_users(self, fake, count, groups):
        ...
        for i in range(count):
            ...
            profile.birth_date = fake.date_of_birth(tzinfo=None, minimum_age=18, maximum_age=80)
        ...
        self.stdout.write(self.style.SUCCESS(f"Created {count} regular users"))
    ...
    def create_admin_users(self, fake):
        ...
        self.stdout.write(self.style.SUCCESS("Created admin users"))
    ...
    def create_notifications(self, fake, users, count):
        ...
        if not users:
            self.stdout.write(self.style.WARNING("No users available for notifications"))
            return
        ...
        notification_templates = {
            "info": {
                "titles": ["System Update Available", "New Feature Released", "Maintenance Scheduled", "Policy Update"],
                "messages": [
            ...
            "success": {
                "titles": ["Profile Updated Successfully", "Payment Processed", "Account Verified", "Task Completed"],
                "messages": [
            ...
            "error": {
                "titles": ["Login Failed", "Payment Failed", "Upload Error", "Connection Issue"],
                "messages": [
            ...
            "welcome": {
                "titles": ["Welcome to Our Platform!", "Getting Started", "Your Account is Ready", "Welcome Aboard!"],
                "messages": [
            ...
            "urgent": {
                "titles": ["Security Alert", "Account Suspended", "Immediate Action Required", "Critical System Error"],
                "messages": [
