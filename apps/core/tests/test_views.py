...
class ContactAndFeedbackTests(TestCase):
    ...
    def test_feedback_post_sets_kind(self):
        self.client.post(
            reverse("core:feedback"),
            {
                ...
                "email": "sam@example.com",
                "subject": "Idea",
                "message": "Dark mode everywhere please.",
            },
        )
    ...
    def test_short_message_rejected(self):
        ...
        self.assertFormError(
            response.context["form"], "message", "Please provide a little more detail (at least 10 characters)."
        )
    ...
    def test_authenticated_user_attached(self):
        ...
        self.client.post(
            reverse("core:contact"),
            {
                ...
                "email": "u@example.com",
                "subject": "Hi",
                "message": "Attached to my account.",
            },
        )
